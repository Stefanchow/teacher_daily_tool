...
#### 难度控制
- **避免复杂任务**：如辩论、报告写作、长篇演讲
- **聚焦可参与的互动口语练习**：确保活动适合目标年级学生参与
...
interface ActivityPlan {
  ...
  duration: number;        // 总时长（分钟）- 与教案不同，活动时长就是总时长
...
- **难度控制**：避免辩论、报告写作、长篇演讲等复杂任务，聚焦互动口语练习
- **新颖性**：严禁重复使用标准模板，每个计划必须感觉新鲜独特
- **年级适配性**：
  - **当前年级：{grade}**
  - 低年级：侧重TPR、韵律、简单竞赛
  - 高年级：侧重逻辑推理、团队策略、信息差
